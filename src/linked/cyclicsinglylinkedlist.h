#ifndef VTECH_DATA_STRUCTURES_CYCLICSINGLYLINKEDLIST_H
#define VTECH_DATA_STRUCTURES_CYCLICSINGLYLINKEDLIST_H
...
class CyclicSinglyLinkedList : public List<data_type> {
private:
    Node<data_type> * last;
...
#include "cyclicsinglylinkedlist.tpp"

#endif //VTECH_DATA_STRUCTURES_CYCLICSINGLYLINKEDLIST_H
